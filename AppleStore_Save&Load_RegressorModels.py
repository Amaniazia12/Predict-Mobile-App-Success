...
for i in range (len(joblib_file_reg)):
    ...
    print('MSE of new test model ',ModelName[i], np.sqrt(mean_squared_error(Y_newtest, predict)))
    print('the  accuracy of new test model ',ModelName[i], r2_score(Y_newtest, predict), '\n')
